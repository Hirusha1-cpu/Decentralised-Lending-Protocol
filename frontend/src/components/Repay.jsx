...
function Repay() {
    ...
    const handleRepay = async () => {
        ...
        try {
            ...
            setStatus(`✅ Successfully repaid ${amount} USDC!`);
            setAmount('');
            await fetchPosition();
        } catch (error) {
    ...
    const handleRepayAll = async () => {
        ...
        try {
            setStatus('Repaying all USDC...');
            await write('BorrowEngine', 'repay', position.debt);
            
            setStatus(`✅ Successfully repaid all USDC!`);
            setAmount('');
            await fetchPosition();
        } catch (error) {
        ...
        <div>
            ...
            <div style={styles.container}>
                <div style={styles.infoBox}>
                    <span>Current Debt: {formatEther(debt)} USDC</span>
                </div>
